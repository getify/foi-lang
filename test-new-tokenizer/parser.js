...
// =============================================================
//
// Map of production name → shaper function. Each shaper receives
// (frame, parts) where parts is the source-ordered, delim-free
// sequence of terminals (tokens) and recursively-shaped child
// nodes. Returns a plain object with at minimum a `type` field;
// the machinery brand-stamps `start`/`end` (and `delims` under
// preserveDelim) onto the returned node. Productions not in this
